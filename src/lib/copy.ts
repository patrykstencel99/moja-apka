export const uiCopy = {
  ...
  today: {
    ...
    quickCapture: {
      ...
      journalLabel: 'Co dziś najbardziej wpłynęło na Twój dzień i co wybierasz na jutro?',
      journalPlaceholder: 'Napisz swoją odpowiedź. To Twoja chwila zatrzymania i decyzji.',
